...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { id: @type.id, name: @type.name, type_id: @type.type_id, url: @type.url } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { id: @type.id, name: @type.name, type_id: @type.type_id, url: @type.url } }
