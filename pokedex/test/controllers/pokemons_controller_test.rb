...
class PokemonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pokemon" do
    assert_difference('Pokemon.count') do
      post pokemons_url, params: { pokemon: { id: @pokemon.id, name: @pokemon.name, url: @pokemon.url } }
    end
  ...
  test "should update pokemon" do
    patch pokemon_url(@pokemon), params: { pokemon: { id: @pokemon.id, name: @pokemon.name, url: @pokemon.url } }
