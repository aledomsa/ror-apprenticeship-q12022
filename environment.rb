    ...
    class Depot
        ...
        def initialize
            @packs = {
                ...
                standard_transportation_pack: { intelligence: %i[cellphone antenna], arsenal: %i[colt_1911],
                                                items: %i[handcuffs medipack chemestry chevy_versa] },
                simple_mission_pack: { intelligence: %i[infopack laptop cellphone antenna], arsenal: %i[colt_1911],
